...
export const NewsComp = () => {
  return (
    ...
    <div className="container">
      <div className="news_page_inner">
        <h2 className="news_page_paragraph_next">Yangiliklar</h2>
        <ul className="news_page_list">
          <li className="news_page_item">
            <img
              src={Job}
              alt="icon"
              className="news_page_img"
              width={371}
              height={209}
            />
            <h4 className="news_page_paragraph">
            Vakansiya! Kontent menejeri kerak
            </h4>
            <p className="news_page_p">
            Doimiy ish uchun onlayn-do'kon V-COMP, talab qilinadi
               Kontent menejeri. Masofadan turib (uyda) ishlash qiyin emas...
            </p>
            <a href="#" className="news_page_link">
            To'liq o'qing
              <img
                src={Right}
                alt="icon"
                className="news_page_symbol"
                width={12}
                height={12}
              />
            </a>
          ...
          <li className="news_page_item">
            <img
              ...
              height={209}
            />
            <h4 className="news_page_paragraph">Bepul kompyuter yig'ish</h4>
            <p className="news_page_p">
          ...
          <li className="news_page_item">
            <img
              ...
              height={209}
            />
            <h4 className="news_page_paragraph">Bepul yetkazib berish</h4>
            <p className="news_page_p">
        ...
        <a href="#" className="news_page_btn">
          Hamma yangiliklar
          <img
            src={Right}
            alt="icon"
