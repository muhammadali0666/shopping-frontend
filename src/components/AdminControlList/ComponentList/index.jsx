      ...
      <table class="table" style={{borderCollapse: "collapse"}}>
        <thead className="control_table_head">
          <tr className="control_table_row">
            <th className="control_th" scope="col">#</th>
            <th className="control_th" scope="col">Title</th>
        ...
        <tbody className="control_table_body">
          <tr>
            <th className="control_th" scope="row">1</th>
            <td className="control_td">Mark</td>
            <td className="control_td">Otto</td>
            <td className="control_td">@mdo</td>
            <td className="control_td">Otto</td>
            <td className="control_td">Otto</td>
            <td className="control_td"><i class="fa-solid fa-pen-to-square" style={{color: "#060f42"}}></i></td>
            <td className="control_td"><i class="fa-solid fa-trash" style={{color: "#060f42"}}></i></td>
          </tr>
